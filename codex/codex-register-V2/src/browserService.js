...
class BrowserService {
    ...
    async oauthLoginAndAuthorize(opts) {
        ...
        const { phone, email, password, redirectUri, onSmsNeeded, onEmailCodeNeeded } = opts;
        ...
        for (let round = 0; round < 30; round++) {
            ...
            // 1. 登录/注册选择页 - 选择手机登录
            if (pageInfo.btns.some(b => b.includes('手机登录'))) {
